...
The game system uses a limited subset of the D&D 5th Edition rules according to the System Reference Document (SRD5.1). Subset is emphasised here, not all possible actions have been implemented. As such it is possible for you to:
1. Talk with NPCs
