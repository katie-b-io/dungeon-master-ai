    ...
    def build_domain(self) -> None:
        ...
        with open(domain_file, 'w') as writer:
            ...
            types.append({
                ...
                "object",
                "subtypes": [
                    "entity", "intent", "item", "puzzle", "attitude",
                    "ability", "room", "door", "weapon", "armor", "equipment",
            ...
            types.append({
                "type": "monster",
                "subtypes": MonsterCollection.get_all_monsters()
            })
            types.append({
                "type": "attitude",
            ...
            predicates.append({
                "predicate": "connected",
                "params": [("door", "door"), ("location", "room"),
                           ("destination", "room")]
            })
            predicates.append({
                "predicate": "locked",
            ...
            predicates.append({
                ...
                "params": [("player", "player"), ("ability", "ability"),
                           ("target", "object")]
            })
            predicates.append({
                "predicate": "can_equipment_check",
                "params": [("player", "player"), ("equipment", "equipment"),
                           ("target", "object")]
            })
            predicates.append({
